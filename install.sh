#!/bin/sh
set -e
# Code generated by godownloader on 2025-03-26T16:11:34Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for buildecho/releases

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/buildecho/releases/releases
